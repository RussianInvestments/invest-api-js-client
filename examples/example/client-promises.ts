...
import { TTechApiClient } from 'invest-js';
import { InstrumentStatus } from 'invest-js/build/compiled_contracts/common';
import { Share } from 'invest-js/build/compiled_contracts/instruments';
import { MarketDataRequest, MarketDataResponse, DeepPartial, SubscribeCandlesRequest, SubscriptionAction, CandleInstrument, SubscriptionInterval, SubscribeOrderBookRequest, OrderBookInstrument, SubscribeTradesRequest, TradeInstrument } from 'invest-js/build/compiled_contracts/marketdata';
